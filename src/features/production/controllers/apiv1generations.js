...
class ApiV1GenerationsController {
    constructor() {
        ...
        this.initialize = (initValues) => {
            ...
            this.router.post("/mtree/:id", makeHandlerAwareOfAsyncErrors(index_1.apiSecured), makeHandlerAwareOfAsyncErrors(this.mTree));
            this.router.post("/mtreescript/:id", makeHandlerAwareOfAsyncErrors(index_1.apiSecured), makeHandlerAwareOfAsyncErrors(this.mTreeBuildupScript));
            this.router.post("/artifact/:id", makeHandlerAwareOfAsyncErrors(index_1.apiSecured), makeHandlerAwareOfAsyncErrors(this.generateArtifact));
            this.router.post("/transform/:id/:transformer", makeHandlerAwareOfAsyncErrors(index_1.apiSecured), makeHandlerAwareOfAsyncErrors(this.transformModel));
            this.router.post("/job", makeHandlerAwareOfAsyncErrors(index_1.apiSecured), makeHandlerAwareOfAsyncErrors(this.executeJob));
            this.router.post("/wizzify", makeHandlerAwareOfAsyncErrors(index_1.apiSecured), makeHandlerAwareOfAsyncErrors(this.wizzify));
            this.router.post("/codeast", makeHandlerAwareOfAsyncErrors(index_1.apiSecured), makeHandlerAwareOfAsyncErrors(this.codeAST));
        };
        this.mTree = 
