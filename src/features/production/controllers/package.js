...
class PackageProductionController {
    constructor() {
        ...
        this.initialize = (initValues) => {
            ...
            this.router.get("/new", makeHandlerAwareOfAsyncErrors(index_1.webSecured), makeHandlerAwareOfAsyncErrors(this.getNewPackageForm));
            this.router.post("/new", makeHandlerAwareOfAsyncErrors(index_1.webSecured), makeHandlerAwareOfAsyncErrors(this.postPackage));
            this.router.get("/update/:id", makeHandlerAwareOfAsyncErrors(index_1.webSecured), makeHandlerAwareOfAsyncErrors(this.getUpdatePackageForm));
            this.router.post("/update", makeHandlerAwareOfAsyncErrors(index_1.webSecured), makeHandlerAwareOfAsyncErrors(this.putPackage));
            this.router.get("/delete/:id", makeHandlerAwareOfAsyncErrors(index_1.webSecured), makeHandlerAwareOfAsyncErrors(this.getDeletePackageForm));
            this.router.post("/delete", makeHandlerAwareOfAsyncErrors(index_1.webSecured), makeHandlerAwareOfAsyncErrors(this.deletePackage));
            this.router.get("/props/:owner/:name", makeHandlerAwareOfAsyncErrors(index_1.webSecured), makeHandlerAwareOfAsyncErrors(this.getPackageProperties));
            this.router.get("/meta/:owner/:name", makeHandlerAwareOfAsyncErrors(index_1.webSecured), makeHandlerAwareOfAsyncErrors(this.getWizziMetaFolderByName));
        };
        ...
        (request, response) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            return (0, meta_1.getTemplatePackiFiles)(request.body.meta_id, request.body.meta_propsValues ? JSON.parse(request.body.meta_propsValues) : {}, request.query.context, request.body.context ? JSON.parse(request.body.context) : {}).then((packiFiles) => (0, package_1.createPackageProduction)(request.session.user.username, request.body.pp_name, request.body.pp_description, JSON.stringify((0, utils_2.mergePackiFiles)(packiFiles, getPackiFiles()))).then((result) => {
                if (result.ok) {
