...
function getRepositories(accessToken) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => (0, node_fetch_1.default)(`https://api.github.com/user/repos`, getOptions(accessToken)).then((response) => {
            if (!response.ok) {
                throw new Error(response.status.toString());
            }
            return response.json();
        }).then((responseData) => resolve(responseData)).catch(err => reject(err)));
    });
}
...
function getRepository(owner, repo, accessToken) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => (0, node_fetch_1.default)(`https://api.github.com/repos/${owner}/${repo}`, getOptions(accessToken)).then((response) => {
            if (!response.ok) {
                throw new Error(response.status.toString());
            }
            return response.json();
        }).then((responseData) => tslib_1.__awaiter(this, void 0, void 0, function* () {
...
function getPackiTemplateRepositories() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => (0, node_fetch_1.default)(`https://api.github.com/users/stfnbssl/repos`, getOptions()).then((response) => {
            if (!response.ok) {
                throw new Error(response.status.toString());
            }
            return response.json();
        }).then((responseData) => {
            return resolve(responseData.filter(value => value.name.startsWith('packi-template-')));
        }).catch(err => reject(err)));
    });
}
...
function createRepository(accessToken, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => (0, node_fetch_1.default)(`https://api.github.com/user/repos`, postOptions(accessToken, options)).then((response) => {
            if (!response.ok) {
                throw new Error(response.status.toString());
            }
            return response.json();
...
function getRevisions(owner, repo, accessToken) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => (0, node_fetch_1.default)(`https://api.github.com/repos/${owner}/${repo}/git/refs/heads`, getOptions(accessToken)).then((response) => {
            if (!response.ok) {
                throw new Error(response.status.toString());
            }
            return response.json();
...
function getBranches(owner, repo, accessToken) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => (0, node_fetch_1.default)(`https://api.github.com/repos/${owner}/${repo}/branches`, getOptions(accessToken)).then((response) => {
            if (!response.ok) {
                throw new Error(response.status.toString());
            }
            return response.json();
...
function createBranch(accessToken, owner, repo, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => (0, node_fetch_1.default)(`https://api.github.com/repos/${owner}/${repo}/git/refs`, postOptions(accessToken, {
...
function getCommits(owner, repo, accessToken) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => (0, node_fetch_1.default)(`https://api.github.com/repos/${owner}/${repo}/commits`, getOptions(accessToken)).then((response) => {
            if (!response.ok) {
                throw new Error(response.status.toString());
            }
            response.json();
...
function getContents(owner, repo, accessToken) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => (0, node_fetch_1.default)(`https://api.github.com/repos/${owner}/${repo}/contents`, getOptions(accessToken)).then((response) => {
            if (!response.ok) {
                throw new Error(response.status.toString());
            }
            response.json();
